...
class Snake(Canvas):
	def __init__(self):
		super().__init__(	width=600,height=620,background='green',highlightthickness=0)
	...
	def load_assets(self):
		self.snake_body_image = Image.open('./im/bodysnake.png')
		self.snake_body = ImageTk.PhotoImage(self.snake_body_image)

		self.food_image = Image.open('./im/food.png')
...
GUI = Tk()
GUI.title('Snake Game by Nattapong Changtong')
